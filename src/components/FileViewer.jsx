...
export default function FileViewer({ file, onClose }) {
  ...
  return (
    <div className="fixed inset-0 bg-black flex items-center justify-center z-50">
      <div className="bg-theme-secondary text-theme-primary rounded-lg max-w-4xl w-full max-h-full overflow-auto p-4 border border-theme">
        <div className="flex justify-between items-center mb-4">
          <h3 className="text-lg font-semibold text-theme-primary">{fileName}</h3>
          <button onClick={onClose} className="bg-theme-accent hover:bg-theme-primary hover:text-theme-inverse text-theme-primary rounded-full w-8 h-8 flex items-center justify-center text-xl font-bold transition-colors">&times;</button>
        </div>
